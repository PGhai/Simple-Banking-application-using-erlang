...
%% API functions
%% ====================================================================
-export([start/0,master/4,display/3,requestToDisplayBalance/4]).

start() ->
	FileData = file:consult("C:/Users/admin/eclipse-workspace/Banking/customer.txt"),
	CustData = element(2,FileData),
    FileBankData = file:consult("C:/Users/admin/eclipse-workspace/Banking/bank.txt"),
	BankData = element(2,FileBankData),
    Pid = spawn(money,master,[CustData,BankData,#{},#{}]),
    Pid ! {data,"start"},
    io:fwrite(" ").
